...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Chat Requests</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String sel = "select Distinct(chat_from_id) from tbl_chat";
                    ResultSet rs = con.selectCommand(sel);

                    while (rs.next()) {
                        i++;
                        String selQry = "select * from tbl_user where user_id='" + rs.getString("chat_from_id") + "'";
                ...
                <tr>
                    ...
                    <td><%=rs1.getString("user_contact_1")%></td>
                    <td><%=rs1.getString("user_email_1")%></td>
                    <td align="center">
                        <a href="Chat/Chat.jsp?uid=<%=rs1.getString("user_id")%>&name=<%=rs1.getString("user_name")%>&photo=<%=rs1.getString("user_photo")%>">Chat</a>
                    </td>
                </tr>
                <%
                    }
