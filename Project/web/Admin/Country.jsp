                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_country" name="txt_country" value="<%=name%>">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="Country.jsp?del=<%=rs.getString("country_id")%>" class="status_btn">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a href="Country.jsp?edit=<%=rs.getString("country_id")%>&name=<%=rs.getString("country_name")%>" class="status_btn">Edit</a></td>
                                            </tr>
                                            <%                      }
