...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\GrievanceFile\\";//path for storing image
                ...
                String ins = "insert into tbl_grievance(grievance_name,departmenttype_id,user_id,grievance_file,grievance_details,grievancetype_id)"
                        + "values('" + value[0] + "',' " + value[1] + "','"+session.getAttribute("uid")+"','"+fn+"','" + value[3] + "','" + value[2] + "')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../User/Grievance.jsp'
            }, 40);
        </script>
        <%
                }
